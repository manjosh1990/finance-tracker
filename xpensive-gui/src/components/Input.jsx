    ...
    return (
        <div className="mb-4">
            ...
            <div className="relative">
                {isSelect ? (
                    <select
                        className="w-full bg-transparent outline-none border border-brand-purple/40 rounded-md py-2
                    px-3 pr-10 leading-tight focus:outline-none focus:border-brand-pink focus:ring-2 focus:ring-brand-pink/60"
                        value={value}
