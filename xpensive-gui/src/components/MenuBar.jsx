...
const MenuBar = () => {
    ...
    return (
        <div className="sticky top-0 z-30">
            <div className="relative flex items-center justify-between gap-5 bg-[var(--color-bg)] text-brand-pink shadow-md px-4 py-4 sm:px-7">
                 ...
                 <div className="relative" ref={dropDownRef}>
                     <button
                         ...
                         bg-brand-purple/20 hover:bg-brand-purple/30 rounded-full transition-colors focus:outline-none
                     ...
                     {/*Drop down menu*/}
                     {showDropdown && (
                        <div className="absolute right-0 mt-2 w-48 rounded-xl p-[1px] bg-gradient-to-r from-brand-pink to-brand-purple z-50 shadow-lg">
                            <div className="bg-[var(--color-bg)] rounded-xl overflow-hidden py-1">
                                 {/**Profile information*/}
                                 <div className="px-4 py-3 border-b border-brand-purple/40 text-sm text-brand-pink font-medium text-center cursor-pointer">
                                     <div className="flex items-center gap-3">
                                         <div className="flex items-center justify-center w-8 h-8 bg-brand-purple/20 rounded-full">
                ...
                <div className="pointer-events-none absolute inset-x-0 -bottom-px h-px bg-gradient-to-r from-brand-pink to-brand-purple/90"></div>
            </div>
        </div>
    )
}
